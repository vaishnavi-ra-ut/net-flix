  ...
  return (
    <div>
      ...
      <div className="flex justify-end -mt-14">
          <div className="w-[2.5%] z-10 my-[3%] mr-[0.7%] ">
      ...
      <div className="z-10 my-[3%] mr-[1%]">
         <button className="py-[5.5%] px-1 bg-[#e3000b] rounded-md text-white" onClick={handleSignOut}>Sign Out</button>
      </div>
      </div> 
      </div>     
    </div>
