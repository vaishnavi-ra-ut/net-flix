    ...
    <div className="flex justify-end bg-gradient-to-b from-black fixed z-20 top-0 w-screen">
      <div className="p-6 z-10 flex ">
          <svg
            ...
            aria-hidden="true"
            role="img"
            className="default-ltr-cache-1d568uk ev1dnif2 p-1 w-32 mr-[55rem]"
          >
          <g>
          <path
